...
var peerUrl = process.argv[2]
var peerPort = process.argv[3]
var channelName = process.argv[4]
var orgName = process.argv[5];
var ordererNum = process.argv[6];
var isRemote = process.argv[7];
var peerName = process.argv[8];
var caCertFile = process.argv[9];
var cprofDir = process.argv[10];
var srvCertFile = process.argv[11];
